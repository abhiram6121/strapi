...
resource "aws_codedeploy_app" "ecs" {
  name             = "abhiram-strapi-codedeploy"
...
resource "aws_codedeploy_deployment_group" "ecs" {
  ...
  deployment_group_name = "abhiram-strapi-codedeploy-group"
  ...
  blue_green_deployment_config {
    ...
    terminate_blue_instances_on_deployment_success {
      action                           = "TERMINATE"
      termination_wait_time_in_minutes = 5 # Requirements: Terminate after success
    }
  }
